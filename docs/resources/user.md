...
- `password` (String, Sensitive) Password of the user. Required when creating a local user; omit when importing to preserve the existing password. Stored in state when supplied.
