...
- `repo_admin_change_team_access` (Boolean) Whether repository admins can add and remove team access.
...
```shell
# Import by organisation name.
terraform import forgejo_organization.defaults existing_org
```
